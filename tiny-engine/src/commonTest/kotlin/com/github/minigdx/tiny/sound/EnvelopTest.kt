...
class EnvelopTest {
    ...
    fun noteOn_zero_attack_starts_at_full_volume() {
        val envelope = Envelop(attack = 0, decay = 50, sustain = 0.7f, release = 200)
    ...
    fun noteOn_zero_decay_jumps_to_sustain() {
        val envelope = Envelop(attack = 100, decay = 0, sustain = 0.7f, release = 200)
    ...
    @Test
    fun noteOff_attack_phase_increases_linearly() {
        val envelope = Envelop(attack = 100, decay = 50, sustain = 0.7f, release = 200)

        assertEquals(0.0f, envelope.noteOff(0), 0.001f)
        assertEquals(0.25f, envelope.noteOff(25), 0.001f)
        assertEquals(0.5f, envelope.noteOff(50), 0.001f)
        assertEquals(1.0f, envelope.noteOff(100), 0.001f)
    }

    @Test
    fun noteOff_decay_phase_decreases_to_sustain() {
        val envelope = Envelop(attack = 100, decay = 50, sustain = 0.7f, release = 200)

        assertEquals(1.0f, envelope.noteOff(100), 0.001f)
        assertEquals(0.85f, envelope.noteOff(125), 0.001f)
        assertEquals(0.7f, envelope.noteOff(150), 0.001f)
    }

    @Test
    fun noteOff_release_phase_decreases_to_zero() {
        val envelope = Envelop(attack = 100, decay = 50, sustain = 0.7f, release = 200)

        assertEquals(0.7f, envelope.noteOff(150), 0.001f)
        assertEquals(0.525f, envelope.noteOff(200), 0.001f)
        assertEquals(0.35f, envelope.noteOff(250), 0.001f)
        assertEquals(0.175f, envelope.noteOff(300), 0.001f)
        assertEquals(0.0f, envelope.noteOff(350), 0.001f)
    }
    ...
    fun noteOff_after_release_stays_silent() {
        ...
        assertEquals(0.0f, envelope.noteOff(350), 0.001f)
        assertEquals(0.0f, envelope.noteOff(400), 0.001f)
        assertEquals(0.0f, envelope.noteOff(1000), 0.001f)
    }

    @Test
    fun noteOff_zero_release_immediately_silent() {
        val envelope = Envelop(attack = 100, decay = 50, sustain = 0.7f, release = 0)

        assertEquals(0.7f, envelope.noteOff(150), 0.001f)
        assertEquals(0.0f, envelope.noteOff(151), 0.001f)
        assertEquals(0.0f, envelope.noteOff(200), 0.001f)
    }

    @Test
    fun noteOff_zero_attack_starts_at_full_volume() {
        val envelope = Envelop(attack = 0, decay = 50, sustain = 0.7f, release = 200)

        assertEquals(1.0f, envelope.noteOff(0), 0.001f)
        assertEquals(0.85f, envelope.noteOff(25), 0.001f)
        assertEquals(0.7f, envelope.noteOff(50), 0.001f)
    }

    @Test
    fun noteOff_zero_decay_jumps_to_sustain() {
        val envelope = Envelop(attack = 100, decay = 0, sustain = 0.7f, release = 200)

        assertEquals(1.0f, envelope.noteOff(100), 0.001f)
        assertEquals(0.6965f, envelope.noteOff(101), 0.001f)
        assertEquals(0.5215f, envelope.noteOff(151), 0.001f)
    }
    ...
    fun envelope_with_full_sustain() {
        val envelope = Envelop(attack = 50, decay = 50, sustain = 1.0f, release = 100)
        ...
        assertEquals(1.0f, envelope.noteOff(100), 0.001f)
        assertEquals(0.5f, envelope.noteOff(150), 0.001f)
        assertEquals(0.0f, envelope.noteOff(200), 0.001f)
    }

    @Test
    fun envelope_with_zero_sustain() {
        val envelope = Envelop(attack = 50, decay = 50, sustain = 0.0f, release = 100)
        ...
        assertEquals(0.0f, envelope.noteOff(150), 0.001f)
        assertEquals(0.0f, envelope.noteOff(200), 0.001f)
    }
}
