...
class GameScript(
    ...
    private fun createLuaGlobals(forValidation: Boolean = false): Globals =
        Globals().apply {
            ...
            load(MapLib(this@GameScript.resourceAccess, gameOptions.spriteSize, virtualFrameBuffer))
            load(GfxLib(this@GameScript.resourceAccess, gameOptions, virtualFrameBuffer))
