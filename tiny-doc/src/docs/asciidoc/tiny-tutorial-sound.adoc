...
++++
<iframe title="Tiny SFX Editor" loading="lazy" width="768" height="516" src="sample/sfx-editor/index.html" style="border: 4px solid #00e5ff; border-radius: 1rem; display: block; margin: 1em auto;"></iframe>
++++
