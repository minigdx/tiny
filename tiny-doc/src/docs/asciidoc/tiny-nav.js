(function () {
    ...
    style.textContent = [
        ...
        '}',
        '.tiny-nav__logo, .tiny-nav__logo:link, .tiny-nav__logo:visited {',
        ...
        '}',
        '.tiny-nav__logo:hover { color: #ff0080 !important; }',
        '.tiny-nav__links {',
        '    display: flex;',
        '    align-items: center;',
        '    gap: 8px;',
        '}',
        '.tiny-nav__link, .tiny-nav__link:link, .tiny-nav__link:visited {',
        '    color: #444 !important;',
        '    text-decoration: none !important;',
        '    margin: 0 12px;',
        '    font-size: 0.85rem;',
        ...
        '    transition: color 0.15s ease;',
        '}',
        '.tiny-nav__link:hover { color: #ff0080 !important; }',
        '.tiny-nav__cta, .tiny-nav__cta:link, .tiny-nav__cta:visited {',
        '    background: #00e5ff;',
        '    color: #fff !important;',
        '    padding: 8px 20px;',
        '    border-radius: 16px;',
        ...
        '}',
        '.tiny-nav__cta:hover, .tiny-nav__cta:focus {',
        '    background: #00d4ec;',
        '    color: #fff !important;',
    ...
    nav.innerHTML = [
        ...
        '    <a href="editor.html" class="tiny-nav__link">Editor</a>',
