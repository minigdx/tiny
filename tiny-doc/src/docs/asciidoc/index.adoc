...
You can try to create a game right away the Tiny Game engine using link:sandbox.html?game=[the Sandbox] or you can just try the engine by updating examples available in this page.

== Tiny is open source

The Tiny Game Engine is an open-source project. Users can contribute to the project by reporting issues, suggesting improvements, and even submitting code changes. https://github.com/minigdx/tiny[Check the code source on Github].
