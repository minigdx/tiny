...
function _update()
    gfx.cls()
    print(tiny.height, 10, 10) -- Height of the game in pixels.
end
</tiny-editor>
++++
...
function _update()
    gfx.cls()
    print(tiny.platform, 10, 10) -- Current platform: 1 for desktop, 2 for web.
end
</tiny-editor>
++++
...
function _update()
    gfx.cls()
    print(tiny.width, 10, 10) -- Width of the game in pixels.
end
</tiny-editor>
++++
